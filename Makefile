...
BOOST_LIB = /usr/local/opt/boost-1.61.0/lib
BOOST_INCLUDE = /usr/local/opt/boost-1.61.0/include
CC = gcc-4.8
CFLAGS = -std=c++11 -I $(BOOST_INCLUDE) -L $(BOOST_LIB) -g -w -O2
CXX = g++-4.8
CXXFLAGS = $(CFLAGS)
ELF0 = run_test
ELF1 = run_trace
...
super: $(HDR) $(OBJ)
	$(CXX) $(CXXFLAGS) -o Experiments/our_demo Experiments/our_demo.cpp $(OBJ) -lboost_serialization
	-chmod $(PERMS) $(OBJ) 
	-chmod $(EPERMS) Experiments/our_demo
